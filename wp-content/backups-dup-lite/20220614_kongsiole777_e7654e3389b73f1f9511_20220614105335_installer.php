...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220614_kongsiole777_e7654e3389b73f1f9511_20220614105335_archive.zip';
	const ARCHIVE_SIZE		 = '24862644';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e7654e3-14105335';
    const SECONDARY_PACKAGE_HASH = '95b4cac-14105335';
	const VERSION			 = '1.4.6';
