...
Tags: Particle js, ParticleJS, Particle JS Background, ParticleJS Slider, ParticleJS Banner, Animated Banner, Slider, Particle js slider, JavaScript Slider, JavaScript Animated Slider, Particle banner, Animated Banner, Animated Background
...
= How can I add text over the Particle Banner? =
...
= How may I change particle size, color and background? =
...
== Screenshots ==
1. Particle Background Setting Appearance 
2. Example of placing Shortcode to the page 
3. Example of selecting particle background as a page template 
4. Particle Events fields 
5. Particle Click Events fields
6. Particle settings options
7. Particle Movement and Line settings options
...
* Fix center align text issue
= 1.1.0 =
* Release date: April 27, 2021
* Fix minor issue
= 1.2.0 =
* Release date: March 2, 2022
* Tested for WP new Version
= 1.3.0 =
* Release date: March 2, 2022
* Fixed bug