<div class="flexslider" id="metaslider-demo">
	<ul class="slides">
		...
		<li>
			...
			<img src="<?php echo esc_url( get_template_directory_uri() ) ?>/slider/backgrounds/1.jpg" class="ms-default-image" width="1080" height="420" alt="<?php esc_attr_e('Demo Slide', 'vantage') ?>" />
		</li>
